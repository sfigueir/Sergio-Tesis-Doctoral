...
En la Figura \ref{fig:gramgeo} definimos la gramática para el {\em lenguaje de geometría} $\gramgeo$.
...
\end{tabular}
\end{center}
\caption{La gramática \gramgeo para el lenguaje de geometría.}
\end{figure}\label{fig:gramgeo}
