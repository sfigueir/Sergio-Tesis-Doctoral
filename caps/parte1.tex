...
\widesanti{Es cierto que esto que sigue queda repetido con la def. formal. No me convence. Propongo que se explique la semántica de estas dos repeticiones con un programita en cualquier pseudo códico imperativo con un ciclo y unos 'prints'. Creo que va a quedar más claro .

Sería más ordenado contar todo esto sin recurrir a la notación de $\sem{}$, que se reservaría para la def. formal}
