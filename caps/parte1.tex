...
\centering
\begin{tabular}{lcll}
\multicolumn{1}{c}{\bf{s}   } & \multicolumn{1}{c}{\mdlgeo(s)} & \multicolumn{1}{c}{Posible $p$} & Otro posible $p$ \\ \hline
\textbf{01234567} &  7      &  \verb#[+0,REP0[+1]^7]# &  \verb#[REP1<+1>[+0]^8]# \\ \hline
\textbf{02460246} &  7      &  \verb#[+0,REP0[+2]^7]# &  \verb#[REP2<+2>[+0]^8]# \\ \hline
\textbf{04512673} &  8      &  \verb#[REP1<-3>[+0,P]^4]# &  \verb#[REP2<-3>[+0,P]^4]# \\ \hline
\textbf{0213243546576071} &  9      &  \verb#[REP1<+1>[+0,+2]^8]# &  \verb#[REP2<+1>[+0,+2]^8]# \\ \hline
\textbf{02360236} &  11      &  \verb#[REP1<+0>[+0,+2,A,B]^2]# &  \verb#[REP1<+0>[+0,+2,+1,+3]^2]# \\ \hline
\end{tabular}
