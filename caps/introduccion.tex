...
Los enfoques simbólicos sostienen que los pensamientos son representaciones simbólicas en un lenguaje del pensamiento (\lot) compuesto por un conjunto limitado de símbolos atómicos que pueden combinarse para formar estructuras nuevas y más complejas siguiendo reglas combinatorias \cite{fodor1975language,nosofsky1994rule, tenenbaum2011grow, maddox1993comparing}. \sergio{Explicar critica conexionismo y surgimiento teoría computacional de la mente?} 
