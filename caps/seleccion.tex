...
\begin{itemize}
\item $\llbracket$\verb#DOUBLE#$\rrbracket_n  \eqdef  n \cdot 2 \mod 8$ 
\item $\llbracket$\verb#-DOUBLE#$\rrbracket_n  \eqdef  -n \cdot 2 \mod 8$  
...
\begin{figure}[!ht]
    ...
    A: secuencias con $|x| = 4$.
    B: secuencias con $|x| = 5$.
    C: secuencias con $|x| = 6$.
    D: secuencias con $|x| = 7$.
    E: secuencias con $|x| = 8$.}
    \label{fig:codR}
\end{figure}
