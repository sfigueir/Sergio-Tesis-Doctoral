...
\intro{a intro, pero dejar algo acá de enganche}{
...
\intro{esto podría ir a intro, como descripcion informal de leng geom (antes de la def de la semántica formal)}{} \color{red}
