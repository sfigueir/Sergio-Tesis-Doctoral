...
Me gustaría unificar notación en toda la tesis. Propuesta (obviamnete se puede cambiar fácil porque son comandos)

lenguajes/gramáticas:

\gramgeo para lenguaje de geometría. No está hecho.

\grambin para lenguaje de binario (sub gramática del anteirior). no está hecho en cap 2.

\grambool para lenguaje de proposicional sin xor. Estaba hecho en el paper de PRE (cap 4) pero fuimos muy informales en el paper de BRM (cap 5)

\gramboolxor para lenguaje de proposicional con xor. Idem.
