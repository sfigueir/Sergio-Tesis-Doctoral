...
\widesanti{ahora pienso que tal vez tenga más sentido poner el capítulo de secuencias binarias al principio. Engancha mejor con lo de plos one, porque las dos son sobre secuencias (al fin de cuentas, lo del octógono son secuencias representadas en el espacio). También pienso que quedaría bien mechar con el paper de PIP (=\textbf{}tesis lic), pero no sé bien dónde iría. Entonces la tesis tendría dos partes (no necesariamente tenemos que dividir en `partes'), la primera sobre secuencias (PCB+Plosone (+PIP?)) y la segunda sobre conceptos (PRE+BRM). PRE+BRM tienen mucho en común y es bueno cerrar con eso}
