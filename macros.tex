...
\theoremstyle{plain}
\theoremstyle{plain}
\newtheorem{theorem}{Teorema} %%% Original
...
% NAMES
\newcommand{\kolcomp}{complejidad de Kolmogorov\xspace}
\newcommand{\Kolcomp}{Complejidad de Kolmogorov\xspace}
\newcommand{\pfree}{libre de prefijos\xspace}
\newcommand{\Pfree}{Libre de prefijos\xspace}
...
\newcommand{\CV}{\C_{\V}} %Plain Kolmogorov complexity based on U
...
\newcommand{\Opt}{Universal\xspace}
\newcommand{\optity}{Universalidad\xspace}
\newcommand{\Optity}{Universalidad\xspace}
